const getPokemonUrl = id = `httpspokeapi.coapiv2pokemon${id}`
...
const generateHTML = pokemons = pokemons.reduce((accumulator, {name, id ,types}) = {
    ...
    accumulator += `
        li class = card ${elemenTypes[0]}
            img class=card-image alt=${name} src=httpsraw.githubusercontent.comPokeAPIspritesmasterspritespokemonotherdream-world${id}.svg  
